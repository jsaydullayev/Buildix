...
public record ApproveRegistrationRequestDto(
    ...
    [property: JsonPropertyName("password")][param: Required][param: StrongPassword] string Password,
...
public record CreateOwnerDto(
    ...
    [property: JsonPropertyName("subdomain")] string? Subdomain = null,
    [property: JsonPropertyName("language")] string? Language = "uz",
    // Subscription end date — same semantics as ApproveRegistrationRequestDto.ExpiresAt.
    [property: JsonPropertyName("expiresAt")] DateTime? ExpiresAt = null
)
{
