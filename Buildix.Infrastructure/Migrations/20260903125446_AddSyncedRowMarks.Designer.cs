...
namespace Buildix.Infrastructure.Migrations
{
    ...
    [Migration("20260903125446_AddSyncedRowMarks")]
    partial class AddSyncedRowMarks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.CashMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.LoginHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.MarketSettings", b =>
                {
                    ...
                    b.Property<bool>("DebtRequiresCloud")
                        .HasColumnType("boolean");
                    ...
                    b.Property<TimeOnly>("LateThreshold")
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasIndex("MarketId", "RegisterCode", "SaleNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.ShopTerminal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastOfflineAlertAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastPushAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.SyncPushState", b =>
                {
                    b.Property<int>("MarketId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("MarketId", "TableName");

                    b.ToTable("SyncPushStates");
                });

            modelBuilder.Entity("Buildix.Domain.Entities.SyncState", b =>
                {
                    b.Property<int>("MarketId")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset>("PullWatermark")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SeedAfter")
                        .HasColumnType("text");

                    b.Property<DateTime?>("SeedCompletedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.SyncedRowMark", b =>
                {
                    b.Property<Guid>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTime>("AppliedUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.TerminalPairingCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TerminalPairingCodes");
                });
            ...
            modelBuilder.Entity("Buildix.Domain.Entities.ZakupReceipt", b =>
                {
                    ...
                    b.HasIndex("MarketId", "ReceiptNumber");
