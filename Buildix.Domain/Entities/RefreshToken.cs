...
public class RefreshToken : BaseEntity
{
    ...
    // ── Sessiya metadatasi (Account "Устройства и сессии") ────────────────
    /// <summary>Qurilma/brauzer (User-Agent'dan soddalashtirilgan), masalan "Windows · Chrome".</summary>
    public string? DeviceInfo { get; set; }

    /// <summary>So'rov kelgan IP manzil.</summary>
    public string? IpAddress { get; set; }

    /// <summary>Bu sessiya oxirgi marta ishlatilgan vaqt (login yoki refresh).</summary>
